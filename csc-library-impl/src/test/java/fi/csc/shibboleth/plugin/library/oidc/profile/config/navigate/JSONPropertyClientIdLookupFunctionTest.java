...
public class JSONPropertyClientIdLookupFunctionTest {

    private JSONPropertyClientIdLookupFunction function;
    ...
    public void setup() {
        ...
        function = new JSONPropertyClientIdLookupFunction();
        Map<String, String> ids = new HashMap<String, String>();
        ids.put("default", "default_id");
        ids.put("https://issuer1", "issuer1_id");
        ids.put("https://issuer2", "issuer2_id");
        function.setClientIds(ids);
    }

    @Test
    public void testMatchingSuccess() {
        Assert.assertEquals(function.apply(nestedPrc), "issuer1_id");
    }

    @Test
    public void testDefaultSuccess() {
        rpCtx.setRelyingPartyId("https://some");
        Assert.assertEquals(function.apply(nestedPrc), "default_id");
    }

    @Test
    public void testNullMap() {
        function.setClientIds(null);
