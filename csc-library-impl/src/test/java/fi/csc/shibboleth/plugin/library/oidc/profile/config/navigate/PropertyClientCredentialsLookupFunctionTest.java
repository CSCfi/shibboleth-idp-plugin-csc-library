...
@TestPropertySource(properties = {
		"csclib.oidc.upstream.clientCredentials={\"default\":\"default_secret\",\"https://issuer1\":\"issuer1_secret\", \"https://issuer2\":\"issuer2_secret\"}" })
public class PropertyClientCredentialsLookupFunctionTest
		extends AbstractPropertyLookupFunctionTest<PropertyClientCredentialLookupFunction> {
